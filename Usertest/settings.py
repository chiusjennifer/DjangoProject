...
SECRET_KEY = "django-insecure-a=k-0^+u0$mnnz+q*6)f$rcylzq9+e4324i270ymmazzmf%)*a"
...
STATIC_URL = "static/"
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # 收集後的 static 路徑
MEDIA_URL = "media/"
...
PWA_APP_DESCRIPTION = "這是一個支援PWA的Django應用程式"
